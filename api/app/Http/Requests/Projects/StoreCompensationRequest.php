...
class StoreCompensationRequest extends FormRequest
{
    ...
    {
        return [
            'comp_no' => 'required|string|max:50',
            'valuation_amount' => 'required|numeric|min:0',
            'negotiated_amount' => 'nullable|numeric|min:0',
            'paid_amount' => 'nullable|numeric|min:0',
            'comp_type' => 'required|in:land_acquisition,crops,structures,disturbance,other',
            'valuation_date' => 'required|date',
            'payment_date' => 'nullable|date',
            'payment_reference' => 'nullable|string|max:100',
            'status' => 'nullable|in:valued,negotiated,approved,paid,disputed',
